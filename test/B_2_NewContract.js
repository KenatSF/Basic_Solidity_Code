...
describe("describe: new Contract()", function () {
  it("Understanding msg.sender = account & msg.sender contractAddress plus new Contract()", async function () {
    // Accounts managament
    const [account1, account2] = await ethers.getSigners();

    // Deploy contracts
    const Contract_Taker = await ethers.getContractFactory("Taker1");
    ...
    await taker.connect(account2).create_contract();
